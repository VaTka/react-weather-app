...
function Inputs() {
    ...
    return <div className="flex flex-row justify-center my-6">
        <div className="flex flex-row w-3/4 items-center justify-center space-x-4">
            <input type="text" placeholder="Search for city..." className="text-xl font-light p-2 w-full focus:outline-none capitalize placeholder:lowercase"/>
        ...
        <div className="flex flex-row w-1/4 items-center justify-center">
            ...
            <button name="emperial" className="text-xl text-white font-light">°F</button>
        </div>
    </div>
